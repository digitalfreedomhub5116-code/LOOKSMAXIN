...
const IMG = {
  turmeric: '/remedies/turmeric.png',
  neem: '/remedies/neem.png',
  sandalwood: '/remedies/sandalwood.png',
  clay: '/remedies/clay.png',
  aloe: '/remedies/aloe.png',
  rose: '/remedies/rose.png',
  honey: '/remedies/honey.png',
  coffee: '/remedies/coffee.png',
  papaya: '/remedies/papaya.png',
  tomato: '/remedies/tomato.png',
  cucumber: '/remedies/cucumber.png',
  lemon: '/remedies/lemon.png',
  milk: '/remedies/milk.png',
  oats: '/remedies/oats.png',
  charcoal: '/remedies/charcoal.png',
  teatree: '/remedies/teatree.png',
  rice: '/remedies/rice.png',
  coconut: '/remedies/coconut.png',
  potato: '/remedies/potato.png',
};
