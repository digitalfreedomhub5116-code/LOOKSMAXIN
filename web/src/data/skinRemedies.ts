...
// Category images mapped to primary ingredients
const IMG = {
...
export const REMEDIES: Remedy[] = [
  {
    ...
    duration: '20 min', frequency: '2-3x per week', color: '#C8A84E', emoji: '✨', image: IMG.turmeric,
  },
  {
    id: 'neem-purifier',
    name: 'Neem Purifier',
    subtitle: 'Anti-acne warrior',
    ...
    duration: '15 min', frequency: '3x per week', color: '#22C55E', emoji: '🌿', image: IMG.neem,
  },
  {
    id: 'chandan-glow',
    name: 'Chandan Glow Pack',
    subtitle: 'Royal skin brightener',
    ...
    duration: '25 min', frequency: '2x per week', color: '#F59E0B', emoji: '🪷', image: IMG.sandalwood,
  },
  {
    id: 'multani-detox',
    name: 'Multani Mitti Detox',
    ...
    duration: '20 min', frequency: '2x per week', color: '#A0522D', emoji: '🏺', image: IMG.clay,
  },
  {
    id: 'aloe-repair',
    name: 'Aloe Repair Gel',
    subtitle: 'Skin soother & healer',
    ...
    duration: '20 min', frequency: 'Daily', color: '#4ADE80', emoji: '🌱', image: IMG.aloe,
  },
  {
    id: 'kadu-bitter',
    name: 'Kadu Neem Lepa',
    subtitle: 'Blood purifier mask',
    ...
    duration: '15 min', frequency: '2x per week', color: '#166534', emoji: '🍃', image: IMG.neem,
  },
  {
    id: 'papaya-enzyme',
    name: 'Papaya Enzyme Peel',
    subtitle: 'Natural chemical peel',
    ...
    duration: '20 min', frequency: '2x per week', color: '#FB923C', emoji: '🍈', image: IMG.honey,
  },
  {
    id: 'doodh-malai',
    name: 'Doodh Malai Pack',
    subtitle: 'Deep moisture ritual',
    ...
    duration: '20 min', frequency: '3x per week', color: '#FEF3C7', emoji: '🥛', image: IMG.honey,
  },
  {
    id: 'tulsi-toner',
    name: 'Tulsi Clarifying Toner',
    subtitle: 'Holy basil skin tonic',
    ...
    duration: '2 min', frequency: 'Daily (AM & PM)', color: '#059669', emoji: '🌺', image: IMG.neem,
  },
  {
    id: 'haldi-doodh',
    name: 'Haldi Doodh Glow',
    subtitle: 'Golden milk face mask',
    ...
    duration: '15 min', frequency: '2-3x per week', color: '#EAB308', emoji: '🌟', image: IMG.turmeric,
  },
  {
    id: 'coffee-scrub',
    name: 'Coffee De-Tan Scrub',
    subtitle: 'Instant tan removal',
    ...
    duration: '10 min', frequency: '2x per week', color: '#78350F', emoji: '☕', image: IMG.coffee,
  },
  {
    id: 'nimbu-honey',
    name: 'Nimbu Honey Brightener',
    subtitle: 'Vitamin C face mask',
    ...
    duration: '15 min', frequency: '2x per week', color: '#FDE047', emoji: '🍋', image: IMG.honey,
  },
  {
    id: 'rose-ice',
    name: 'Rose Ice Facial',
    subtitle: 'Pore-tightening ritual',
    ...
    duration: '5 min', frequency: 'Daily', color: '#F472B6', emoji: '🧊', image: IMG.rose,
  },
  {
    id: 'methi-pack',
    name: 'Methi Anti-Aging Pack',
    subtitle: 'Fenugreek firming mask',
    ...
    duration: '20 min', frequency: '2x per week', color: '#A16207', emoji: '🫘', image: IMG.turmeric,
  },
  {
    id: 'cucumber-cool',
    name: 'Cucumber Cool Mask',
    subtitle: 'Under-eye rescue',
    ...
    duration: '15 min', frequency: 'Daily', color: '#86EFAC', emoji: '🥒', image: IMG.aloe,
  },
  {
    id: 'charcoal-deep',
    name: 'Charcoal Deep Clean',
    subtitle: 'Blackhead eliminator',
    ...
    duration: '15 min', frequency: '1x per week', color: '#374151', emoji: '⚫', image: IMG.clay,
  },
  {
    id: 'tomato-tan',
    name: 'Tomato Tan Eraser',
    subtitle: 'Lycopene brightener',
    ...
    duration: '20 min', frequency: '3x per week', color: '#EF4444', emoji: '🍅', image: IMG.honey,
  },
  {
    id: 'kesar-cream',
    name: 'Kesar Radiance Cream',
    subtitle: 'Luxury glow booster',
    ...
    duration: '30 min / overnight', frequency: '3x per week', color: '#DC2626', emoji: '🏵️', image: IMG.sandalwood,
  },
  {
    id: 'oats-gentle',
    name: 'Oats Gentle Scrub',
    subtitle: 'Sensitive skin cleanser',
    ...
    duration: '12 min', frequency: '2-3x per week', color: '#D4A574', emoji: '🌾', image: IMG.clay,
  },
  {
    id: 'tea-tree-spot',
    name: 'Tea Tree Spot Fix',
    subtitle: 'Overnight pimple killer',
    ...
    duration: 'Overnight', frequency: 'As needed', color: '#34D399', emoji: '🎯', image: IMG.aloe,
  },
  {
    id: 'rice-water',
    name: 'Rice Water Toner',
    subtitle: 'Korean-Ayurvedic hybrid',
    ...
    duration: '2 min', frequency: 'Daily', color: '#E5E7EB', emoji: '🍚', image: IMG.rose,
  },
  {
    id: 'amla-vitamin',
    name: 'Amla Vitamin Pack',
    ...
    duration: '20 min', frequency: '2x per week', color: '#84CC16', emoji: '🫒', image: IMG.aloe,
  },
  {
    id: 'coconut-lip',
    name: 'Coconut Lip Rescue',
    subtitle: 'Lip repair balm',
    ...
    duration: 'Overnight', frequency: 'Daily', color: '#BE185D', emoji: '👄', image: IMG.honey,
  },
  {
    id: 'potato-dark',
    name: 'Potato Dark Spot Fade',
    subtitle: 'Natural bleaching agent',
    ...
    duration: '20 min', frequency: 'Daily', color: '#D97706', emoji: '🥔', image: IMG.turmeric,
  },
  {
    id: 'honey-glow',
    name: 'Raw Honey Glow Mask',
    subtitle: 'The simplest glow hack',
    ...
    duration: '20 min', frequency: 'Daily safe', color: '#F59E0B', emoji: '🍯', image: IMG.honey,
  },
];
