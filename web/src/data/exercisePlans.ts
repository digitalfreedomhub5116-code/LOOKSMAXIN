...
const JAW_EXERCISES: Omit<ExerciseItem, 'id'>[] = [
  { name: 'Mewing Hold', duration: 180, sets: 1, reps: 0, difficulty: 1, description: 'Place tongue flat against roof of mouth. Hold position with lips sealed and teeth lightly touching.', frames: ['/exercises/jawline/mewing-hold-1.png', '/exercises/jawline/mewing-hold-2.png'] },
  { name: 'Chin Tuck', duration: 120, sets: 3, reps: 15, difficulty: 1, description: 'Pull chin straight back creating a double chin. Hold 2 seconds, release. Keep eyes level.', frames: ['/exercises/jawline/chin-tuck-1.png', '/exercises/jawline/chin-tuck-2.png'] },
  { name: 'Jaw Clench & Release', duration: 120, sets: 3, reps: 20, difficulty: 1, description: 'Clench jaw firmly for 3 seconds, then slowly release. Focus on masseter engagement.', frames: ['/exercises/jawline/jaw-clench-1.png', '/exercises/jawline/jaw-clench-2.png'] },
  { name: 'Neck Curl', duration: 90, sets: 3, reps: 12, difficulty: 2, description: 'Lie face up, tuck chin and curl head off ground. Hold 2 seconds at top. Keep shoulders down.', frames: ['/exercises/jawline/neck-curl-1.png', '/exercises/jawline/neck-curl-2.png'] },
  { name: 'Tongue Press', duration: 120, sets: 3, reps: 15, difficulty: 1, description: 'Press tongue hard against roof of mouth for 5 seconds. Release. Focus on hyoid engagement.', frames: ['/exercises/jawline/tongue-press-1.png', '/exercises/jawline/tongue-press-2.png'] },
  { name: 'Jaw Side Slide', duration: 90, sets: 3, reps: 12, difficulty: 2, description: 'Slide jaw left, hold 2 seconds, center, slide right, hold. Keep teeth apart.', frames: ['/exercises/jawline/jaw-slide-1.png', '/exercises/jawline/jaw-slide-2.png', '/exercises/jawline/jaw-slide-3.png'] },
  { name: 'Resistance Jaw Open', duration: 120, sets: 3, reps: 10, difficulty: 2, description: 'Place fist under chin. Open jaw against resistance of fist. Hold 3 seconds open.', frames: ['/exercises/jawline/resistance-jaw-1.png', '/exercises/jawline/resistance-jaw-2.png'] },
